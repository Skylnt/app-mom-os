#!/bin/bash
# Upload built docs to preview.lpbsapps.com
...
echo "Uploading to http://preview.lpbsapps.com/c/${TRAVIS_COMMIT} ..."
time gsutil -q -m cp -z html,css,js,svg -r "./${TRAVIS_COMMIT}" gs://preview.lpbsapps.com/c/
echo 'Done.'
